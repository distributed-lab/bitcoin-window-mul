...
impl<T, const WIDTH: usize> WindowedPrecomputeTable<T, WIDTH>
where
    T: NonNativeLimbInteger,
{
    ...
    fn precompute_4_mul() -> Script {
        script! {
            ...
            { T::OP_ADD(1, 0) }          // {0, z, 2*z, 3*z, 4*z, 5*z, 6*z, 7*z, 8*z, 9*z, 10*z, 11*z, 12*z, 13*z}
            { T::OP_PICK(6) }            // {0, z, 2*z, 3*z, 4*z, 5*z, 6*z, 7*z, 8*z, 9*z, 10*z, 11*z, 12*z, 13*z, 7*z}
            { T::OP_2MUL(0) }            // {0, z, 2*z, 3*z, 4*z, 5*z, 6*z, 7*z, 8*z, 9*z, 10*z, 11*z, 12*z, 13*z, 14*z}
            ...
            { T::OP_ADD(1, 0) }          // {0, z, 2*z, 3*z, 4*z, 5*z, 6*z, 7*z, 8*z, 9*z, 10*z, 11*z, 12*z, 13*z, 14*z, 15*z}
        }
    }
