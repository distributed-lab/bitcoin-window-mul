...
pub fn u29x9_mul_karazuba(a: u32, b: u32) -> Script {
    script! {
        ...
        { U254::OP_ZIP(a as usize, b as usize) }
        // ⋯ A₈ B₈ A₇ B₇ A₆ B₆ A₅ B₅ A₄ B₄ A₃ B₃ A₂ B₂ A₁ B₁ A₀ B₀
...
mod test {
    ...
    fn test_u29x9_mul_karazuba() {
        ...
        let script = script! {
            ...
            // c =
            {382214224} OP_EQUALVERIFY
            {45845824} OP_EQUALVERIFY
            {463831460} OP_EQUALVERIFY
            {429352739} OP_EQUALVERIFY
            {370746904} OP_EQUALVERIFY
            {299929355} OP_EQUALVERIFY
            {235682882} OP_EQUALVERIFY
            {236494238} OP_EQUALVERIFY
            {487138221} OP_EQUALVERIFY
            {432728939} OP_EQUALVERIFY
            {126248025} OP_EQUALVERIFY
            {481080595} OP_EQUALVERIFY
            {214642611} OP_EQUALVERIFY
            {77049607} OP_EQUALVERIFY
            {217714847} OP_EQUALVERIFY
            {425230593} OP_EQUALVERIFY
